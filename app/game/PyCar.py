...
class Car:
    image_car = ['RacingCar01.png', 'RacingCar02.png', 'RacingCar03.png', 'RacingCar04.png', 'RacingCar05.png', \
                 ...
                 'RacingCar15.png', 'RacingCar16.png', 'RacingCar17.png', 'RacingCar18.png', 'RacingCar20.png']
    ...
    def load_image(self):
        ...
        self.image = pygame.image.load(PATH_RES + random.choice(self.image_car))
...
def draw_main_menu():
    ...
    image_intro = pygame.image.load(PATH_RES + 'PyCar.png')
    ...
    screen.blit(text_score, [draw_x, draw_y + 140])
    text_start = font_30.render("Press Space Key to Start!", True, RED)
    screen.blit(text_start, [draw_x, draw_y + 210])
    pygame.display.flip()
...
if __name__ == '__main__':
    ...
    pygame.mixer.music.load(PATH_RES + 'race.wav')
    sound_crash = pygame.mixer.Sound(PATH_RES + 'crash.wav')
    sound_engine = pygame.mixer.Sound(PATH_RES + 'engine.wav')
